...
void DataSummary::setSummary(const EWOPE::Data &data)
{
    ...
    if(data.getFlag() == "A" || data.getFlag() == "R") //ammetto numeri negativi come VALIDI!
        this->n_valid_values = this->n_samples - this->n_nd_values - this->n_empty - this->n_allowed_symbols;

    else
        this->n_valid_values = this->n_samples - this->n_nd_values - this->n_empty - this->n_allowed_symbols - this->n_negative_values;
